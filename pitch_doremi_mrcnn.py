...
Usage:
    ...
    06/09/2023
    nohup python3 doremi_mrcnn.py train --weights=coco > hepworth-6sept_test_gpu_new.txt
    ...
    nohup python3 doremi_mrcnn.py evaluate --weights=coco --logs=/homes/es314/pitch_Mask_RCNN/logs/doremi20230906T1723/ > evaluate_hepworth-6sept_test_gpu_new.txt
